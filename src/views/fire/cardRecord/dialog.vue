            ...
            <el-row :gutter="35">
              ...
              <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                <el-form-item label="" prop="userDept">
                  <el-input v-model="state.ruleForm.userDept" placeholder="请输入" clearable></el-input>
                </el-form-item>
              </el-col>
              ...
              <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                <el-form-item label="" prop="clockingMode">
                  <el-input v-model="state.ruleForm.clockingMode" placeholder="请输入" clearable></el-input>
                </el-form-item>
              </el-col>

              <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                <el-form-item label="" prop="clockingPoint">
                  <el-input v-model="state.ruleForm.clockingPoint" placeholder="请输入" clearable></el-input>
                </el-form-item>
              </el-col>

              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
                <el-form-item label="" prop="remark">
                  <el-input type="textarea" :rows="3"  v-model="state.ruleForm.remark" placeholder="请输入" clearable></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
